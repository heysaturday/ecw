            ...
            if (!empty($locations)) {
                ...
                foreach ($locations as $location) {
                    if ($items[$location['id']]) {
                        ...
                        $wpdb->query($wpdb->prepare(
                            "INSERT IGNORE INTO `singleplatform` (
							`ID`,
							`content`,
							`imported`
						) VALUES (
    ...
    //////////////////////////////////////////////////
        ...
        function isBrowser()
        {
            ...
            if (strpos(strtolower($userAgent), "chrome/")) { // Chrome
                return true;
            } elseif (strpos(strtolower($userAgent), "msie")) { // Internet Explorer
                return true;
            } elseif (strpos(strtolower($userAgent), "firefox/")) { // Firefox
                return true;
            } elseif (strpos(strtolower($userAgent), "safari/")) { // Safari
                return true;
            }
            return false;
        }
