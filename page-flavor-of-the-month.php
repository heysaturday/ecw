<?php
/**
 * Template Name: Flavor of the Month
 */
	get_header();
...
<section class="layout-promo" style="background-color:<?php the_field('background_color'); ?>; background-image:url('<?php echo $image; ?>');">
	<article>
		<h2 style="border-color:<?php the_field('color', $flavor); ?>; color:<?php the_field('color', $flavor); ?>;">Flavor of the&nbsp;Month: <strong><?php echo $flavor->post_title; ?></strong></h2>
		<div>
			<?php the_content(); ?>
			<ul class="sharing">
				<li class="twitter">
